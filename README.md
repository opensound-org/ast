...
Latest version: [v0.3.1](https://github.com/opensound-org/est/releases/tag/v0.3.1)
...
![MSRV (version)](https://img.shields.io/crates/msrv/est/0.3.1?label=v0.3.1-msrv)
[![dependency status (version)](https://deps.rs/crate/est/0.3.1/status.svg?subject=v0.3.1-deps)](https://deps.rs/crate/est/0.3.1)

...
Latest version: [v0.3.0](https://github.com/opensound-org/est/releases/tag/v0.3.0)
...
![MSRV (version)](https://img.shields.io/crates/msrv/est/0.3.0?label=v0.3.0-msrv)
[![dependency status (version)](https://deps.rs/crate/est/0.3.0/status.svg?subject=v0.3.0-deps)](https://deps.rs/crate/est/0.3.0)
